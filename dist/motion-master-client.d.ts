...
export declare class MotionMasterClient {
    ...
    requestComputeFullAutoTuningGains(deviceAddress: DeviceAddressType, type: MotionMasterMessage.Request.ComputeFullAutoTuningGains.Type, controllerType?: MotionMasterMessage.Request.ComputeAutoTuningGains.PositionParameters.ControllerType, messageId?: string): Observable<MotionMasterMessage.Status.FullAutoTuning>;
    ...
    requestStartCirculoEncoderConfiguration(deviceAddress: DeviceAddressType, encoderOrdinal: number, messageId?: string): Observable<MotionMasterMessage.Status.CirculoEncoderConfiguration>;
    requestStopCirculoEncoderNarrowAngleCalibrationProcedure(deviceAddress: DeviceAddressType, encoderOrdinal: number, messageId?: string): Observable<MotionMasterMessage.Status.CirculoEncoderNarrowAngleCalibrationProcedure>;
    requestStartOsCommand(deviceAddress: DeviceAddressType, timeoutMs: number, command: Uint8Array, messageId?: string): Observable<MotionMasterMessage.Status.OsCommand>;
    /**
